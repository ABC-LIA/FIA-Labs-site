...
//#region node_modules/.nitro/vite/services/ssr/assets/work.index-wXZW_QQA.js
var import_jsx_runtime = require_jsx_runtime();
function WorkPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageFrame, {
		index: "01 · Work",
		title: "The desk.",
		dek: "Eight specialist systems. Seven desks are in production on their own domains. CarCounsel is named here until it can ship at the same standard.",
